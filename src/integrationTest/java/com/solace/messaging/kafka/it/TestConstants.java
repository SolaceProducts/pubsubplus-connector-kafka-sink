...
public interface TestConstants {
    ...
    public static final String CONNECTORLIB = "pubsubplus-connector-kafka-sink/lib";
    public static final String CONNECTORDESTINATION = "src/integrationTest/resources/";
    public static final String CONNECTORPROPERTIESFILE = CONNECTORDESTINATION+"pubsubplus-connector-kafka-sink/etc/solace_sink.properties";
    public static final String CONNECTORJSONPROPERTIESFILE = CONNECTORDESTINATION+"pubsubplus-connector-kafka-sink/etc/solace_sink_properties.json";
