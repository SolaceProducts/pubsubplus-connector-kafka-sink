...
public class SolaceSinkConfig extends AbstractConfig{
	...
	public static ConfigDef solaceConfigDef() {
		return new ConfigDef()
				.define(SolaceSinkConstants.SOL_USERNAME, Type.STRING, "default", Importance.HIGH,
						"Solace username")
				.define(SolaceSinkConstants.SOL_PASSWORD, Type.STRING, "default", Importance.HIGH,
				...
				.define(SolaceSinkConstants.SOl_QUEUE, Type.STRING, null, Importance.MEDIUM,
						"Solace queue to consume from")
				.define(SolaceSinkConstants.SOL_RECORD_PROCESSOR, Type.CLASS,
						SolRecordProcessor.class, Importance.HIGH,
				...
				.define(SolaceSinkConstants.SOL_GENERATE_SEND_TIMESTAMPS, Type.BOOLEAN, false, Importance.LOW,
						"indicates whether to generate a send timestamp in outgoing messages")
				.define(SolaceSinkConstants.SOL_GENERATE_RCV_TIMESTAMPS, Type.BOOLEAN, false, Importance.LOW,
						"Indicates whether to generate a receive timestamp on incoming messages")
				.define(SolaceSinkConstants.SOL_GENERATE_SEQUENCE_NUMBERS, Type.BOOLEAN, false, Importance.LOW,
						"Indicates whether to generate a sequence number in outgoing messages")
				.define(SolaceSinkConstants.SOL_CALCULATE_MESSAGE_EXPIRATION, Type.BOOLEAN, false, Importance.LOW,
				...
				.define(SolaceSinkConstants.SOL_PUB_USE_INTERMEDIATE_DIRECT_BUF, Type.BOOLEAN, true, Importance.LOW,
				...
				.define(SolaceSinkConstants.SOL_MESSAGE_CALLBACK_ON_REACTOR, Type.BOOLEAN, false, Importance.LOW,
				...
				.define(SolaceSinkConstants.SOL_IGNORE_DUPLICATE_SUBSCRIPTION_ERROR, Type.BOOLEAN, false, Importance.LOW,
						"ignore errors caused by subscriptions being already presents")
				.define(SolaceSinkConstants.SOL_IGNORE_SUBSCRIPTION_NOT_FOUND_ERROR, Type.BOOLEAN, false, Importance.LOW,
				...
				.define(SolaceSinkConstants.SOL_SUB_ACK_WINDOW_SIZE, Type.INT, 255, Importance.LOW,
						"The size of the sliding subscriber ACK window. The valid range is 1-255")
				.define(SolaceSinkConstants.SOl_AUTHENTICATION_SCHEME, Type.STRING, "AUTHENTICATION_SCHEME_BASIC", Importance.MEDIUM,
						"String property specifying the authentication scheme.")
				.define(SolaceSinkConstants.SOL_KRB_SERVICE_NAME, Type.STRING, "solace", Importance.MEDIUM,
				...
				.define(SolaceSinkConstants.SOL_SSL_CONNECTION_DOWNGRADE_TO, Type.STRING, "", Importance.MEDIUM,
				...
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_connectTimeoutInMillis, Type.INT, 30000, Importance.MEDIUM,
						"Timeout value (in ms) for creating an initial connection to Solace")
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_readTimeoutInMillis, Type.INT, 10000, Importance.MEDIUM,
						"Timeout value (in ms) for reading a reply from Solace")
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_connectRetries , Type.INT, 0, Importance.MEDIUM,
				...
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_reconnectRetries , Type.INT, 0, Importance.MEDIUM,
				...
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_connectRetriesPerHost, Type.INT, 0, Importance.MEDIUM,
				...
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_reconnectRetryWaitInMillis, Type.INT, 3000, Importance.MEDIUM,
						"How much time in (MS) to wait between each attempt to connect or reconnect to a host")
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_keepAliveIntervalInMillis, Type.INT, 3000, Importance.MEDIUM,
						"The amount of time (in ms) to wait between sending out keep-alive messages")
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_keepAliveLimit, Type.INT, 10, Importance.MEDIUM,
				...
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_sendBuffer, Type.INT, 65536, Importance.MEDIUM,
						"The size (in bytes) of the send socket buffer.")
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_receiveBuffer, Type.INT, 65536, Importance.MEDIUM,
						"The size (in bytes) of the receive socket buffer.")
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_tcpNoDelay, Type.BOOLEAN, true, Importance.LOW,
						"Whether to set the TCP_NODELAY option. When enabled, this option disables the Nagle's algorithm.")
				.define(SolaceSinkConstants.SOL_CHANNEL_PROPERTY_compressionLevel, Type.INT, 0, Importance.MEDIUM,
				...
				//.define(SolaceSinkConstants.SOL_SSL_PROTOCOL, Type.STRING, "SSLv3,TLSv1,TLSv1.1,TLSv1.2", Importance.LOW,
				...
				.define(SolaceSinkConstants.SOL_SSL_VALIDATE_CERTIFICATE, Type.BOOLEAN, true, Importance.LOW,
						"This property is used to specify whether the API should validate server certificates ")
				.define(SolaceSinkConstants.SOL_SSL_VALIDATE_CERTIFICATE_DATE, Type.BOOLEAN, true, Importance.LOW,
						"This property is used to specify whether the API should validate server certificate's expiry")
				.define(SolaceSinkConstants.SOL_SSL_TRUST_STORE, Type.STRING, "/lib/security/jssecacerts", Importance.LOW,
				...
				.define(SolaceSinkConstants.SOL_SSL_TRUST_STORE_FORMAT, Type.STRING, "JKS", Importance.LOW,
						"This property is used to specify the format of the truststore given in SSL_TRUST_STORE.")
				.define(SolaceSinkConstants.SOL_SSL_TRUSTED_COMMON_NAME_LIST, Type.STRING, "", Importance.LOW,
				...
				.define(SolaceSinkConstants.SOL_SSL_KEY_STORE_NORMALIZED_FORMAT, Type.STRING, "JKS", Importance.LOW,
				...
				.define(SolaceSinkConstants.SOL_SSL_PRIVATE_KEY_ALIAS, Type.STRING, "", Importance.LOW,
						"This property is used to specify the alias of the private key to use for client certificate authentication.")
				.define(SolaceSinkConstants.SOL_SSL_PRIVATE_KEY_PASSWORD, Type.STRING, "", Importance.LOW,
						"This property is used to specify the password that deciphers the private key from the key store.")
				.define(SolaceSinkConstants.SOL_ACK_EVENT_MODE, Type.STRING, "SUPPORTED_ACK_EVENT_MODE_WINDOWED", Importance.MEDIUM,
						"API sends out message acknowledgement event for Guaranteed Messages, windowed or per message.")
