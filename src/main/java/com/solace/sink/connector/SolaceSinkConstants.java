...
public class SolaceSinkConstants {
	...
	//Low importance properties for Message Producer Flow Properties (Solace ProducerFlowProperties.class)
	...
	//Allowable values  for the test sample include: NONE, DESTINATION, CORRELATION_ID, CORRELATION_ID_AS_BYTES
