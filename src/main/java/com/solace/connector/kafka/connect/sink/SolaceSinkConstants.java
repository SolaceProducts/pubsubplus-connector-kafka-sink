 ...
 */
public class SolaceSinkConstants {
  ...
  public static final String SOL_CHANNEL_PROPERTY_sendBuffer
  ...
  // Low importance properties for Message Producer Flow Properties (Solace
  // ProducerFlowProperties.class)
  public static final String SOL_SUPPORTED_ACK_EVENT_MODE = "sol.supported_ack_event_mode";
  public static final String SOL_PUBLISHER_WINDOW_SIZE = "sol.publisher_window_size";
  ...
  public static final String SOL_EMIT_KAFKA_RECORD_HEADERS_ENABLED = "sol.emit.kafka.record.headers.enabled";
