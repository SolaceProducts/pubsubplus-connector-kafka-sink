...
public class SolaceSinkConnectorConfig extends AbstractConfig {
  ...
  public static ConfigDef solaceConfigDef() {
    return new ConfigDef()
            .define(
                    SolaceSinkConstants.SOL_USERNAME,
                    Type.STRING,
                    "default",
                    Importance.HIGH,
                    "Solace username"
            ...
            .define(
                    SolaceSinkConstants.SOL_VPN_NAME,
                    Type.STRING, "default",
                    Importance.HIGH,
                    "Solace VPN to connect with "
            )
            .define(
                    SolaceSinkConstants.SOL_TOPICS,
                    Type.STRING,
                    null,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_RECORD_PROCESSOR,
                    Type.CLASS,
                    SolRecordProcessorIF.class,
                    Importance.HIGH,
                    "default Solace message processor to use against Kafka Sink Records"
            )
            .define(
                    SolaceSinkConstants.SOL_LOCALHOST,
                    Type.STRING,
                    null,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_CLIENT_NAME,
                    Type.STRING,
                    "default",
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_GENERATE_SENDER_ID,
                    Type.BOOLEAN,
                    false,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_REAPPLY_SUBSCRIPTIONS,
                    Type.BOOLEAN,
                    true,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_GENERATE_SEND_TIMESTAMPS,
                    Type.BOOLEAN,
                    false,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_GENERATE_RCV_TIMESTAMPS,
                    Type.BOOLEAN,
                    false,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_GENERATE_SEQUENCE_NUMBERS,
                    Type.BOOLEAN,
                    false,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_CALCULATE_MESSAGE_EXPIRATION,
                    Type.BOOLEAN,
                    false,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_PUB_MULTI_THREAD,
                    Type.BOOLEAN,
                    true,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_PUB_USE_INTERMEDIATE_DIRECT_BUF,
                    Type.BOOLEAN,
                    true,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_MESSAGE_CALLBACK_ON_REACTOR,
                    Type.BOOLEAN,
                    false,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_IGNORE_DUPLICATE_SUBSCRIPTION_ERROR,
                    Type.BOOLEAN,
                    false,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_IGNORE_SUBSCRIPTION_NOT_FOUND_ERROR,
                    Type.BOOLEAN,
                    false,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_NO_LOCAL,
                    Type.BOOLEAN,
                    false,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_SUB_ACK_WINDOW_SIZE,
                    Type.INT,
                    255,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_QUEUE_MESSAGES_AUTOFLUSH_SIZE,
                    Type.INT,
                    200,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOl_AUTHENTICATION_SCHEME,
                    Type.STRING,
            ...
            .define(
                    SolaceSinkConstants.SOL_KRB_SERVICE_NAME,
                    Type.STRING,
                    "solace",
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_SSL_CONNECTION_DOWNGRADE_TO,
                    Type.STRING,
                    "",
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOl_USE_TRANSACTIONS_FOR_QUEUE,
                    Type.BOOLEAN,
                    true,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_connectTimeoutInMillis,
                    Type.INT,
                    30000,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_readTimeoutInMillis,
                    Type.INT,
                    10000,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_connectRetries,
                    Type.INT,
                    0,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_reconnectRetries,
                    Type.INT,
                    0,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_connectRetriesPerHost,
                    Type.INT,
                    0,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_reconnectRetryWaitInMillis,
                    Type.INT,
                    3000,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_keepAliveIntervalInMillis,
                    Type.INT,
                    3000,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_keepAliveLimit,
                    Type.INT,
                    10,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_sendBuffer,
                    Type.INT,
                    65536,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_receiveBuffer,
                    Type.INT,
                    65536,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_tcpNoDelay,
                    Type.BOOLEAN,
                    true,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_CHANNEL_PROPERTY_compressionLevel,
                    Type.INT,
                    0,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_SUBSCRIBER_LOCAL_PRIORITY,
                    Type.INT,
                    1,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_SUBSCRIBER_NETWORK_PRIORITY,
                    Type.INT,
                    1,
                    Importance.MEDIUM,
                    "Subscriber priority is used to choose a client to receive messages "
            ...
            .define(
                    SolaceSinkConstants.SOL_SUBSCRIBER_DTO_OVERRIDE,
                    Type.BOOLEAN,
                    true,
                    Importance.LOW,
            ...
            // use.")
            .define(
                    SolaceSinkConstants.SOL_SSL_EXCLUDED_PROTOCOLS,
                    Type.STRING,
                    "",
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_SSL_CIPHER_SUITES,
                    Type.STRING,
                    "",
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_SSL_VALIDATE_CERTIFICATE,
                    Type.BOOLEAN,
                    true,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_SSL_VALIDATE_CERTIFICATE_DATE,
                    Type.BOOLEAN,
                    true,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_SSL_TRUST_STORE,
                    Type.STRING,
            ...
            .define(SolaceSinkConstants.SOL_SSL_TRUST_STORE_FORMAT,
                    ...
                    "This property is used to specify the format of the truststore "
                            + "given in SSL_TRUST_STORE.")
            .define(
                    SolaceSinkConstants.SOL_SSL_TRUSTED_COMMON_NAME_LIST,
                    Type.STRING,
                    "",
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_SSL_KEY_STORE,
                    Type.STRING,
                    "",
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_SSL_KEY_STORE_FORMAT,
                    Type.STRING,
                    "JKS",
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_SSL_KEY_STORE_NORMALIZED_FORMAT,
                    Type.STRING,
                    "JKS",
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_SSL_PRIVATE_KEY_ALIAS,
                    Type.STRING,
                    "",
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_ACK_EVENT_MODE,
                    Type.STRING,
            ...
            .define(
                    SolaceSinkConstants.SOL_PUBLISHER_WINDOW_SIZE,
                    Type.INT,
                    18,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_KAFKA_MESSAGE_KEY,
                    Type.STRING,
                    "NONE",
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_KAFKA_REPLAY_OFFSET,
                    Type.LONG,
                    null,
                    Importance.LOW,
            ...
            .define(
                    SolaceSinkConstants.SOL_DYNAMIC_DESTINATION,
                    Type.BOOLEAN,
                    false,
                    Importance.MEDIUM,
            ...
            .define(
                    SolaceSinkConstants.SOL_KERBEROS_KRB5_CONFIG,
                    Type.STRING,
                    "",
                    Importance.LOW,
                    "The location of the KRB5 configuration file for the Kerberos Server Detail"
            )
            .define(SolaceSinkConstants.SOL_KERBEROS_LOGIN_CONFIG,
                    Type.STRING,
                    "",
                    Importance.LOW,
  ...
  public SolRecordProcessorIF getSolRecordProcessor() {
    return getConfiguredInstance(SolaceSinkConstants.SOL_RECORD_PROCESSOR, SolRecordProcessorIF.class);
  }
