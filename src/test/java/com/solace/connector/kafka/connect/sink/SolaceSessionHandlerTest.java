...
public class SolaceSessionHandlerTest {
	...
	private enum SolacePasswordProperties {
		PASSWORD(SolaceSinkConstants.SOL_PASSWORD, JCSMPProperties.PASSWORD),
		SSL_KEY_STORE_PASSWORD(SolaceSinkConstants.SOL_SSL_KEY_STORE_PASSWORD,
				JCSMPProperties.SSL_KEY_STORE_PASSWORD),
		SSL_PRIVATE_KEY_PASSWORD(SolaceSinkConstants.SOL_SSL_PRIVATE_KEY_PASSWORD,
				JCSMPProperties.SSL_PRIVATE_KEY_PASSWORD),
		SSL_TRUST_STORE_PASSWORD(SolaceSinkConstants.SOL_SSL_TRUST_STORE_PASSWORD,
